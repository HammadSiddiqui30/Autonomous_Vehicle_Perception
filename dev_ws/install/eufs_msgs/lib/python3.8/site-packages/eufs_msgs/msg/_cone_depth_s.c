...
bool eufs_msgs__msg__cone_depth__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._cone_depth.ConeDepth", full_classname_dest, 35) == 0);
  }
  eufs_msgs__msg__ConeDepth * ros_message = _ros_message;
  {  // color
...
{
  /* NOTE(esteve): Call constructor of ConeDepth */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._cone_depth");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeDepth");
