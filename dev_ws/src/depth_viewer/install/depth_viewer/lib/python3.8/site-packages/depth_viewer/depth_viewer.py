...
class DepthViewer(Node):
    def __init__(self):
        ...
        self.cone_depth_pub = self.create_publisher(ConesDepth, '/depth_cone_center', 2)  
    ...
    def synced_callback(self, left_image_msg, depth_image_msg, bounding_boxes_msg):
        ...
        cones_depth.header.stamp = msg.header.stamp
        cones_depth.header.frame_id = msg.header.frame_id
...
# ...    
            ...
            # Draw bounding boxes on the left image
                ...
                cone_depth.color= bounding_box.color
        ...
        cones_depth.image_header.stamp = msg.header.stamp
        cones_depth.image_header.frame_id = msg.header.frame_id
            
            
        self.cone_depth_pub.publish(cones_depth)   
